...
import logging
import os
import random  # Добавляем импорт модуля random для выбора случайных сообщений
...
# List of encouraging messages for successful result submission
ENCOURAGING_MESSAGES = [
    "Есть! Ну всё, теперь точно пора в команду супергероев! 🦸‍🎯",
    "Браво! С прицелом явно дружишь! 🎯😉",
    "Меткий выстрел! Стреляешь — аж мурашки! Или это просто восторг… 🔥😄",
    "Отличный результат! С такими попаданиями — прямо как из кино! 🎬🎯",
    "Вау! Ещё немного — и тир начнёт бояться тебя первым! 😅🎯",
    "Снайперский результат! Прямо дорога на олимпиаду по меткости! 🏆😄",
    "Чётко в цель! Кажется, прицел встроен прямо в интуицию! 📈🧬🎯",
    "Есть попадание! Фан-клуб уже выехал, готовь автографы! 🌟🎯",
    "Точно в яблочко! Яблоко в шоке, а мы — в восторге! 🍎😆",
    "Безупречно! Меткость просто зашкаливает! 💯🎯",
    "Великолепный выстрел! С таким подходом и будильник не выживет! ⏰🎯",
    "Меткость на высоте! Арбалет случайно где-то рядом? 🏹😉",
    "Ух ты! Кажется, удача сегодня на твоей стороне! 😮🍀",
    "Отлично! Целеустремлённость — мощнее любого эспрессо! ☕🎯",
    "Мастерский выстрел! Даже мишени начинают уважать! 😊🌠",
    "Безукоризненно! Если бы меткость приносила бонусы — уже целая коллекция! 💸🎯",
    "Вот это да! Такой фокус с целями — уровень профи! 😄🎯",
    "Твёрдая рука! После такого выстрела даже вселенная аплодирует! ✍️🌌",
    "Блестяще! Точность прямо как в учебниках! 📊😎",
    "Ну вот, снова в цель! Ты там что, в тайне тренируешься по ночам? 🌙🎯",
    "Кажется, мишень начала сомневаться в своих шансах. Ты просто на высоте! 🥇🎯",
    "Такой выстрел — будто вселенная сказала: «ДА!» ✨🎯",
    "Ого! Такое чувство, что у тебя встроен режим «100 из 100». 🔄🎯",
    "С каждым попаданием всё больше похоже на магию. Ты заряжаешь позитивом! ✨😄🎯"
]
...
async def handle_result(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if validate_input(best_series, total_tens):
        ...
        await update.message.reply_text(random.choice(ENCOURAGING_MESSAGES))
    else:
        await update.message.reply_text(
