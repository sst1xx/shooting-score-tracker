...
CONGRATULATORY_MESSAGES = [
    "💫 Великолепные волшебники точности! Каждый ваш выстрел приближает к новым высотам. Вперёд, к новым достижениям — начнём новый сезон с огоньком! ✨",
    "🥳 Ура, друзья! Сезон завершён, но впереди — бескрайние горизонты доброты и успеха. 🦸‍♀️🦸‍♂️ Спасибо за ваши сердца, бьющееся в унисон. Встретим новый сезон с вдохновением!",
    "🎉 Смелые друзья, ваш упорный труд и страсть к победе освещают путь вперёд. Дерзайте и не останавливайтесь — пора зажечь в новом сезоне! 💪",
    "🎈 С окончанием сезона, друзья! Ваши меткие выстрелы и тёплые улыбки — бесценны. 🍀 В новом сезоне пусть вас согревает поддержка близких — начнём с улыбки!",
    "✨ Вы — наши звёзды, освещающие путь теплом и радостью. 🌟 Спасибо за вашу энергию. Новый сезон принесёт ещё больше волшебства — откроем его вместе!",
    "🏆 Дорогие участники, вы дарите нам любовь к спорту и жизни. 💪 Пусть новый сезон будет наполнен счастливыми мгновениями и уютом — начнём его с верой в себя!",
    "🚀 Вы способны на большее! Каждый ваш успех — доказательство силы воли и упорства. Не останавливайтесь — сделаем первый шаг в новый сезон прямо сейчас!",
    "✨ Дорогие друзья, вы — наше вдохновение и поддержка. Ваше тепло и энтузиазм наполняют нас радостью. 🧡 Новый сезон встретим вместе, он обещает быть волшебным — пусть начнётся с тепла сердец! 🌿",
    "🔥 Дерзайте, стрелки! Каждый выстрел — шаг к новым вершинам. Вера в себя движет вперёд — откройте новый сезон уверенно!",
    "🌟 Отважные стрелки, ваши успехи вселяют смелость и настрой на победы! Вы на верном пути, и впереди — только новые вершины! 🚀 Давайте начнём покорение с первого шага!",
    "💯 Вы — сердце нашего тира. Ваша страсть и доброта объединяют нас всех! 🥇 Пусть впереди будет только радость и вдохновение — начнём сезон с широкой улыбки!",
    "❤️ Помните, вы не одни: мы всегда рядом, чтобы поддержать и вдохновить. Пусть новый сезон согревает вас любовью — открывайте его с добром!",
    "🌠 Ваши достижения — уютный очаг вдохновения для всех нас. Благодарим за ваш позитив и поддержку! 🤩 Новый сезон принесёт ещё больше тёплых моментов — встретим их с радостью!",
    "🎇 Ваши результаты — словно салют тёплых чувств! 🌌 Спасибо за каждый момент вместе. Новый сезон — новая глава нашего дружного приключения, начнём её ярко!",
    "🎉 Поздравляем всех с яркими результатами! 🎯 Ваше участие и дружба — самое ценное. Пусть новый сезон наполнится тёплыми моментами и вдохновением — шагнём в него вместе!",
    "💖 Ваше участие и вера в себя — самый тёплый подарок. Вы делаете наш мир светлее! 🙏 Пусть новый сезон наполнится яркими огоньками успеха — давайте зажжём их вместе!",
    "🌸 Ваши улыбки и дружеская поддержка — самая тёплая награда. В новом сезоне пусть будет много светлых моментов — начните его с доброй встречи!",
    "🎊 Дорогие друзья, ваша сплочённость и талант делают атмосферу особенной. 🙌 Спасибо, что вы с нами. Впереди — новые свершения и победные обнимашки — откроем этот путь сейчас!",
    "🍂 Ощутите уют каждого мгновения: ваши успехи — это семейное дело, и мы гордимимся каждым из вас. Тепла и вдохновения — пусть новый сезон начнётся с заботы друг о друге!",
    "🥳 От всего сердца поздравляем наших героев! Ваше старание и забота друг о друге создают настоящую атмосферу дома. 🏅 Пусть новый сезон будет наполнен любовью и радостью — встречаем его с открытым сердцем!"
]
